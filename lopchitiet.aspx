<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="lopchitiet.aspx.cs" Inherits="BTL_nhom10.lopchitiet" %>
...
<head runat="server">
    ...
    <link href="./filecss/lopchitiet.css" type="text/css" rel="stylesheet" />
...
<body>
    ...
    <section class="containbody lopchitietmargin">
            <div id="hello" class="hello" runat="server"></div>
            <div class="diendan" id="diendan" runat="server">
                
            </div>
            <section id="ND" runat="server"></section>
    </section>
    <footer>
        <aside class="aside">
            <h2><b>Trang web bài giảng học trực tuyến G-H</b></h2>
            <p class="footer">Trang web được thiết kế bởi 2 sinh viên lớp 1810A05 - ĐH Mở HN</p>
        </aside>
        <section class="GH">
            <h3><b>Liên hệ</b></h3>
